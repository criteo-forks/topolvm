...
| controller.csiProvisioner.extraArgs | list | `[]` | Additional arguments appended to the built-in csi-provisioner arguments. Users are responsible for ensuring they are valid csi-provisioner args. |
| controller.csiResizer.extraArgs | list | `[]` | Additional arguments appended to the built-in csi-resizer arguments. Users are responsible for ensuring they are valid csi-resizer args. |
